package com.github.fac30ff.spring.training.batchkafka.producer;
...
public class CustomerProducer {
  public static void main(String[] args) {
    SpringApplication.run(CustomerProducer.class, args);
  }
    ...
    var reader = new ItemReader<Customer>() {
      ...
      public Customer read() {
        if (id.incrementAndGet() < 10_1000) {
          return new Customer(id.get(), Math.random() > .5 ? "Hanna" : "Ivar");
        }
        return null;
      }
    };
